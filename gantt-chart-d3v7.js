d3.gantt = function(target) {
    ...
    let selector = 'target';
    let dateDomainStart = d3.time.day.offset(new Date(),-3);
    let dateomainEnd = d3.time.hour.offset(new Date(),+3);
    let dateDomainMode = FIT_TIME_DOMAIN_MODE;// fixed or fit
    let taskTypes = [];
    let taskStatus = [];
